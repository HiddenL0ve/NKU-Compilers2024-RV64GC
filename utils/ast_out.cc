...
void __Program::printAST(std::ostream &s, long long int pad) {
...
void CompUnit_Decl::printAST(std::ostream &s, long long int pad) { decl->printAST(s, pad); }

/*
DeclStmt
    Id name:a scope:0 type:long long int
*/
void VarDecl::printAST(std::ostream &s, long long int pad) {
...
void VarDef_no_init::printAST(std::ostream &s, long long int pad) {
...
void VarDef::printAST(std::ostream &s, long long int pad) {
    s << std::string(pad, ' ') << "VarDef   name:" << name->get_string() << "   "
      << "scope:" << scope << "\n";
    if (dims != nullptr) {
        s << std::string(pad + 2, ' ') << "Dimensions:\n";
...
void ConstDef::printAST(std::ostream &s, long long int pad) {
...
void ConstInitVal::printAST(std::ostream &s, long long int pad) {
...
void ConstInitVal_exp::printAST(std::ostream &s, long long int pad) {
...
void VarInitVal::printAST(std::ostream &s, long long int pad) {
...
void VarInitVal_exp::printAST(std::ostream &s, long long int pad) {
...
void ConstDecl::printAST(std::ostream &s, long long int pad) {
...
// FunctionDefine function name:main, type:long long int()
//   FuncParams
//   BlockStmt
void CompUnit_FuncDef::printAST(std::ostream &s, long long int pad) { func_def->printAST(s, pad); }

// FunctionDefine function name:main, type:long long int()
void __FuncDef::printAST(std::ostream &s, long long int pad) {
...
void __FuncFParam::printAST(std::ostream &s, long long int pad) {
...
void __Block::printAST(std::ostream &s, long long int pad) {
...
void BlockItem_Decl::printAST(std::ostream &s, long long int pad) { decl->printAST(s, pad); }

void BlockItem_Stmt::printAST(std::ostream &s, long long int pad) { stmt->printAST(s, pad); }

void assign_stmt::printAST(std::ostream &s, long long int pad) {
...
void FuncRParams::printAST(std::ostream &s, long long int pad) {
...
void Func_call::printAST(std::ostream &s, long long int pad) {
...
void UnaryExp_plus::printAST(std::ostream &s, long long int pad) {
    s << std::string(pad, ' ') << "UnaryExp_plus:(+)   " << attribute.GetAttributeInfo() << "\n";
    unary_exp->printAST(s, pad + 2);
}

void UnaryExp_neg::printAST(std::ostream &s,  long long int pad) {
    s << std::string(pad, ' ') << "UnaryExp_neg:(-)   " << attribute.GetAttributeInfo() << "\n";
    unary_exp->printAST(s, pad + 2);
}

void UnaryExp_not::printAST(std::ostream &s,  long long int pad) {
    s << std::string(pad, ' ') << "UnaryExp_not:(!)   " << attribute.GetAttributeInfo() << "\n";
    unary_exp->printAST(s, pad + 2);
}

void IntConst::printAST(std::ostream &s,  long long int pad) {
    s << std::string(pad, ' ') << "Intconst   val:" << val << "   " << attribute.GetAttributeInfo() << "\n";
}

void FloatConst::printAST(std::ostream &s, long long int pad) {
    s << std::string(pad, ' ') << "Floatconst   val:" << val << "   " << attribute.GetAttributeInfo() << "\n";
}

void PrimaryExp_branch::printAST(std::ostream &s, long long int pad) {
    s << std::string(pad, ' ') << "PrimaryExp_branch   " << attribute.GetAttributeInfo() << "\n";
    exp->printAST(s, pad + 2);
}

void ifelse_stmt::printAST(std::ostream &s, long long int pad) {
...
void if_stmt::printAST(std::ostream &s, long long int pad) {
...
void while_stmt::printAST(std::ostream &s, long long int pad) {
...
void continue_stmt::printAST(std::ostream &s, long long int pad) { s << std::string(pad, ' ') << "ContinueStmt\n"; }

void break_stmt::printAST(std::ostream &s, long long int pad) { s << std::string(pad, ' ') << "BreakStmt\n"; }

void return_stmt::printAST(std::ostream &s, long long int pad) {
    s << std::string(pad, ' ') << "ReturnStmt:\n";
    return_exp->printAST(s, pad + 2);
}

void return_stmt_void::printAST(std::ostream &s, long long int pad) {
    s << std::string(pad, ' ') << "ReturnStmt_void   type:void\n";
}

void StringConst::printAST(std::ostream &s, long long int pad) {
    s << std::string(pad, ' ') << "StringConst   type:string   val:" << str->get_string() << "\n";
}

void null_stmt::printAST(std::ostream &s, long long int pad) { s << std::string(pad, ' ') << "NullStmt\n"; }